...
extern void XtFree (String);
extern void * XtMalloc (unsigned int);
extern void XBell (int, int);
extern int XtDisplay (Widget);
extern void * XtRealloc (String, int);

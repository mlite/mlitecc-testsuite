...
int __sync_add_and_fetch (void *, int);
int __sync_sub_and_fetch (void *, int);
int __sync_or_and_fetch (void *, int);
int __sync_xor_and_fetch (void *, int);
int __sync_and_and_fetch (void *, int);
int __sync_nand_and_fetch (void *, int);
int __sync_val_compare_and_swap (void *, int, int);
int __sync_bool_compare_and_swap (void *, int, int);
int __sync_lock_test_and_set (void *, int);
int __sync_synchronize ();
int __sync_lock_release (void *);
